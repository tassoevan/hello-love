...
function Tiago:load()
  ...
  objects.ground.body = love.physics.newBody(world, 640/2, 640-20/2) --remember, the shape (the rectangle we create next) anchors to the body from its center, so we have to move it to (650/2, 650-50/2)
  objects.ground.shape = love.physics.newRectangleShape(1366, 20) --make a rectangle with a width of 650 and a height of 50
...
function Tiago:draw()
  love.graphics.print(contacts, 100, 100)
